...
import EditPurPriceDetailForEditCont from '../../dialogconts/OrderModule/EditPurPriceDetailForEditCont';

class EditPurPriceDetailTableComp extends Component {
    constructor(props, context) {
        super(props, context);
        this.materialUnitCode = {};
        this.columns = [
            {
                title: '行号',
    ...
    render() {
        ...
        let dataSource = list || [];
        let {  onChange, editPurPriceDetail_visible, type, ...props } = this.props;
        return (
...
export default EditPurPriceDetailTableComp;