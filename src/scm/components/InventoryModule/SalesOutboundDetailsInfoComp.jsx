...
class SalesOutboundDetailsInfoComp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            displayInfo:'block',
                        ...
                        <Row className="row-first">
                            <Col className="col-left" span={8}>
                                ...
                                <div className="per-col">
                                    ...
                                    <span>
                                        {this.props.dataSource.sourceOrderType?window.ENUM.getEnum("billType", this.props.dataSource.sourceOrderType):
                                            formatNullStr('')}
                                    </span>
                                </div>
                            </Col>
                            <Col className="col-center" span={8}>
                                ...
                                <Row>
                                    <Col span={12}>
                                        <div className="per-col">
                                            <span className="second-per-name">客户：</span>
                                            <span>
                                        ...
                                        <div className="per-col">
                                            <span className="second-per-name">交货日期：</span>
                                            <span>
                                                {this.props.dataSource.deliveryDate ? this.props.dataSource.deliveryDate.match(/\d{4}\-\d{2}\-\d{2}/)[0]
                                                    : formatNullStr('')}
                                            </span>
                                        </div>
                                    </Col>
...
export default SalesOutboundDetailsInfoComp