...
import ImportStorageErrorComp from '../../components/InventoryModule/ImportStorageErrorComp';
class ImportStorageComp extends FormModalComp {
    constructor(props, context) {
        ...
        this.files = {
            name: 'file',
            action: Urls.COMMON_UPLOAD_FILE,//'http://10.99.2.70:9098/pub/common/uploadfile',//Urls
        ...
        return (
            <div className="upload-dialog">
                <div className="upload-tiitle">
                    <p>请选择需要导入的文件</p>
                    <a href="http://10.99.2.217/importexcel/1hyxKSoAuV0502433301993.xlsx">下载《仓位导入模版》</a>
                </div>
                ...
                <ImportStorageErrorComp {...this.props}/>
            </div>
        )
...
ImportStorageComp.defaultProps={
    title: '批量导入',
    okText: '开始导入',
    width: 690,
    maskClosable: true,
...
export default ImportStorageComp;
