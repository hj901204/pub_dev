...
class ReceiptDetailsComp extends Component {
    ...
    tablePaging = (current) => {
        store.dispatch(PurchaseListAct.takeOrderDetailsMaterialPm(typeof current == 'number' ? Object.assign(this.props.newState.search, { page: current }) : Object.assign(this.props.newState.search, current)));
    }
                        ...
                        <Row className={this.state.infoClassName}>
                            ...
                            <Col span={8}>
                                <div className="receipt-sigle-info">
                                    <h3>源单信息</h3>
                                    <p><span className="receipt-size-lable">供应商：</span><span>{formatNullStr(info.bpName)}</span></p>
