...
class ProductionStorageGoodsTableComp extends Component {
    ...
    tablePaging = (page) => {
        store.dispatch(ProductionStorageTopAct.tablePagingForReceiveGoodsTable(page))
    }
...
export default ProductionStorageGoodsTableComp
