...
import SalesSideComp from './SalesSideComp';
...
class SalesReturnListComp extends Component {
    constructor(props, context) {
        ...
        columns[3].render = (txt, record, index) =><TooltipComp attr={{text: <span className="purchase-color-href" onClick={()=>this.props.openSideBarSub({customerCode:record.bpCode,langCode:record.langCode})}>{record.bpName}</span>, wid: 140}} />
...
// openSideBar = (record) => {
//     this.props.openSideBar(true,{saleReturnCode:record.sourceOrderCode});   
// }
...
componentDidMount() {
           this.props.PurchaseList({page:1,pageSize:10,sourceOrderType:32});
}
searchBar=()=>{//查询按钮
     let  searchVal = this.props.form.getFieldsValue();
     this.props.PurchaseList({page:1, pageSize:this.props.newState.paging.pageSize,sourceOrderType:32,...searchVal})
...
export default Form.create()(SalesReturnListComp)
