...
class ProductionInventorySelectComp extends FormModalComp{
        ...
        columns[columns.length - 1].render=(text,record,index)=>{
            ...
            return <Form onSubmit={this.handleSubmit}>
                        ...
                        {this.props.form.getFieldDecorator(record.idStr, {
                            ...
                            <Input placeholder="0" className="inventory-select-number" type="number" onChange={this.handleOnChange}/>
                        )}
                        </FormItem>
                    </Form>
        }
...
ProductionInventorySelectComp.defaultProps={
    title: '库存选择',
    okText: '确定',
    width: 740,
    maskClosable: true,  
}
export default Form.create()(ProductionInventorySelectComp);
