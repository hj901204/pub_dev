...
import {Form,Input, Button, Select,Checkbox,Popconfirm,message} from '../../../base/components/AntdComp';
import MTable from '../../../base/components/TableComp';
import ProductionSideComp from './ProductionSideComp';
...
class ProductionListComp extends Component {
...
// openSideBar = (record) => {
//     this.props.openSideBar(true,{returnCode:record.sourceOrderCode});   
// }
...
componentDidMount() {
           this.props.PurchaseList({page:1,pageSize:10,sourceOrderType:33});
}
searchBar=()=>{//查询按钮
     let  searchVal = this.props.form.getFieldsValue();
     this.props.PurchaseList({page:1, pageSize:this.props.newState.paging.pageSize,sourceOrderType:33,...searchVal})
...
export default Form.create()(ProductionListComp)
