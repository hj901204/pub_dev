...
class PurchaseReturnSearch extends Component{
    constructor(props) {
        super(props);
        this.state = {
            selectCode: '',
    ...
    search = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            this.props.getList({page:1, pageSize:this.props.paging.pageSize,sourceOrderType:31,[values.searchType]:values.searchType != "status"?values.searchContent:Number(values.searchStatus)});
        })
    };
                    ...
                    <FormItem className="form-item">
                        {getFieldDecorator('searchType',{
                            ...
                            <Select className="search-type" onChange={this.cleanSearch}>
                                ...
                                <Option value="bpFull">供应商</Option>
...
let PurchaseReturnSearchComp = Form.create()(PurchaseReturnSearch)

export default PurchaseReturnSearchComp
