        ...
        this.columns = [
            {
                ...
                obj: {
                    ...
                    format: (item) => (<div className='auto-complete-option'><p className='auto-complete-option-p'><span>{item.code}</span> 【{item.name}】</p>
...
class PreReceiptOperationDialogComp extends FormModalComp {
    constructor(props, context) {
        super(props, context);
            ...
            <div className='pre-receipt-dialog'>
                <div className="pre-receipt-dialog-title">
                    <div className="pre-receipt-dialog-title-left">
                        <p className="pre-receipt-dialog-title-left-up"><span>物料编码：{record.materialCode || ''}</span><span>物料名称：{record.materialName || ''}</span></p>
...
export default PreReceiptOperationDialogComp;
