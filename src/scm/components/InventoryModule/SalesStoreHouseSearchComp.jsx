...
class SalesStoreHouseSearch extends Component{
    ...
    search = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            this.props.getList({page:1, pageSize:this.props.paging.pageSize,sourceOrderType:12, [values.searchType]:values.searchType != 'status' ?values.searchContent:Number(values.searchStatus)});
        })
    };
