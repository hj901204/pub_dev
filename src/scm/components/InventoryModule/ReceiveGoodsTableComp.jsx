...
class ReceiveGoodsTableComp extends Component {
    ...
    tablePaging = (page) => {
        store.dispatch(PurchaseEidtTopAct.tablePagingForReceiveGoodsTable(page))
    }
...
export default ReceiveGoodsTableComp
