...
import ImportSupplierViewComp from './ImportSupplierViewComp';
import ImportCustomerComp from '../../components/RenterModule/ImportCustomerComp';
class ImportCustomerViewComp extends FormModalComp {
        ...
        return (
            <div className="upload-dialog">
                <div className="upload-tiitle">
                    <p>请选择需要导入的文件</p>
                    <a href="http://10.99.2.217/importexcel/1lBS56zSS1U502675832222.xlsx">下载《客户导入模版》</a>
                </div>
...
ImportCustomerViewComp.defaultProps={
    title: '批量导入',
    okText: '开始导入',
    width: 690,
    maskClosable: true,
...
export default ImportCustomerViewComp;
