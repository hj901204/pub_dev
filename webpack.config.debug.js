    ...
    return  {
        ...
        module: {
            loaders: [
                ...
                {test: /\.(png|jpg)$/,loader: 'url-loader?name=img/[hash:8].[name].[ext]&limit=8192&outputPath=/img/'},  //relative
                {test: /\.(eot|svg|ttf|woff)$/,loader: 'url-loader?name=/fonts/[hash:8].[name].[ext]'}
            ]
        }
    }
});
